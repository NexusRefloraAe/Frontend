...
const PerfilUsuario = () => {
    ...
    const fetchUserData = async () => {
      try {
        ...
        if (data.dataNascimento) {
          if (
            data.dataNascimento.includes("T") ||
        ...
        let rawUrl =
          data.fotoUsuario?.url ||
          data.fotoUsuarioResponseDTO?.url ||
          data.fotoUrl ||
          null;
        if (rawUrl) {
  ...
  return (
    <div className="perfil-compact-container">
      <FormGeral
        title={
          isEditing ? "Editar Perfil" : "Gerencie suas informações pessoais"
        }
        ...
        <div className="perfil-form-wrapper">
          <div className="perfil-side-photo">
            ...
            >
              ...
              />
              {isEditing && <div className="photo-edit-label">Trocar Foto</div>}
            </div>
          </div>
