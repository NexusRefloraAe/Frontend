...
const GerarRelatorioInsumo = () => {
  ...
  const handleFiltrarLocalmente = () => {
    ...
    const filtrados = dadosOriginais.filter(item => {
        const matchNome = !nomeInsumo || item.NomeInsumo.toLowerCase().includes(nomeInsumo.toLowerCase());
      ...
      <div className="gerar-relatorio-insumo-content">
        ...
        <section className="filtros-section">
          ...
          <FiltrosRelatorio
            ...
            camposFiltro={[ // Adicione os campos que faltam
          ...
          <div style={{ marginTop: '1rem', display: 'flex', gap: '1rem' }}>
            <button onClick={() => handleExportar('csv')} className="btn-export">Exportar CSV</button>
            <button onClick={() => handleExportar('pdf')} className="btn-export">Exportar PDF</button>
          </div>
